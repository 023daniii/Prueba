...
public class LdVWHormigaDTO {
    private String IdLdHormiga;
    private String LdTipo;
    private String LdSexo;
    private String LdEstadoHormiga;
    ...
    public LdVWHormigaDTO(String idLdHormiga, String ldTipo, String ldSexo, String ldEstadoHormiga, String ldNombre,
            String ldDescripcion, String ldEstado, String ldFechaCreacion, String ldFechaModifica) {
        this.IdLdHormiga = idLdHormiga;
        this.LdTipo = ldTipo;
        this.LdSexo = ldSexo;
        this.LdEstadoHormiga = ldEstadoHormiga;
    ...
    public String getIdLdHormiga() {
        return IdLdHormiga;
    }

    public void setIdLdHormiga(String idLdHormiga) {
        this.IdLdHormiga = idLdHormiga;
    }

    public String getLdTipo() {
        return LdTipo;
    }

    public void setLdTipo(String ldTipo) {
        this.LdTipo = ldTipo;
    }
    ...
    public void setLdSexo(String ldSexo) {
        this.LdSexo = ldSexo;
    }

    public String getLdEstadoHormiga() {
        return LdEstadoHormiga;
    }

    public void setLdEstadoHormiga(String ldEstadoHormiga) {
        this.LdEstadoHormiga = ldEstadoHormiga;
    }
    ...
    public String toString() {
        ...
        + "\n  LdTipo             : "+ getLdTipo()
        + "\n  LdSexo             : "+ getLdSexo()
        + "\n  LdEstadoHormiga    : "+ getLdEstadoHormiga()
